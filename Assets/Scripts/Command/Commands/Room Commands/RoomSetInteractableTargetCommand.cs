...
namespace OSGames.BoardGame {
    public class RoomSetTargetCommand : RoomCommand {
        ...
        override public void Execute(){
            ...
            // setTargetAction.NewTarget = m_RoomController.RoomModel.TargetedInteractable.GetNext().transform;
            ...
            m_RoomController.RoomModel.TargetedInteractable = m_RoomController.RoomModel.TargetedInteractable.GetNext();
